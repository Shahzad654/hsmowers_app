...
class _PricingScreenState extends State<PricingScreen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Text('Pricing', style: AppTextStyles.h4,),
        ...
        body: Column(
          ...
          children: [
            Text('Choose your plan', style: AppTextStyles.h3.copyWith(color: Colors.black),),
            SizedBox(
            height: 40,
          ),
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
              ...
              Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 15,),
                    Text('Gain Customers', style: AppTextStyles.h5.copyWith(color: Colors.black),)
                  ],
                ),
                 SizedBox(
                height: 20,
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Column(
                children: [
                  Text('Subscribe Annually', style: AppTextStyles.h5.copyWith(color: Colors.white),),
                  Text(
                    '\$12.00 per year',
